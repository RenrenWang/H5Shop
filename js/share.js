...
function shareAction(sb, bh) {
	...
	var msg = {
		//content: "商铺http://pic6.huitu.com/res/20130116/84481_20130116142820494200_1.jpg",
	   //pictures: ['http://pic6.huitu.com/res/20130116/84481_20130116142820494200_1.jpg'],
		extra: {
				scene: sb.x
			}
		};
		msg.title="商铺商铺！！！";
		msg.content=document.getElementById('prdtext').textContent?document.getElementById('prdtext').textContent+document.getElementById('details-img').getAttribute('data-src'):"优品卖"+document.getElementById('details-img').getAttribute('data-src');
		//				if(bh) {
